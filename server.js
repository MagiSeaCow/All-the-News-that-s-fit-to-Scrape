...
var MONGODB_URI =
  ...
  db.Comments.create({ comment: "user comments" })
    ...
    {
      // Using the id passed in the id parameter, prepare a query and search for matching onein db
      db.News.findOne({ _id: req.params.id })
      // populate all of the notes associated with it
      .populate("comments")
      .then(function(dbArticle)
      {
        // Successfully find an Article with the id, send it back to the client
        res.json(dbArticle);
      })
      .catch(function(err)
      {
